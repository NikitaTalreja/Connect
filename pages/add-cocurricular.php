...
<body>
    ...
    <section id="cocurricular-section">
        <div class="cocurricular clearfix">
            ...
            <form action="http://localhost/connect/pages/scripts/resume/add.php" id="" method="post">
               <div class="one">
                <div class="left-side pull-left">
                    <div class="row">
                        <label for="">Event Name
                    <input type="text" placeholder="e.g Hackathon" name="event_name">
                    </label>
                        <label for="">Organised By
                    <input type="text" placeholder="e.g VESIT PRAXIS 2018" name="organisation_name">
                    </label>
                    </div>
                ...
                <input type="submit" class="yellow-btn resume-submit" name="cocurricular-submit" value="Submit">
                </div>
            </form>
            <a href="http://localhost/connect/pages/add-extracurricular.php" class="yellow-btn next-button" name="cocurricular-next">Next</a>
